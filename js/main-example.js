var dtl = {
    init : function() {
        ...
        $('.downloads .changelog').click(dtl.openChangelog);
        $('.downloads .changelog-text .close').click(dtl.closeChangelog);
    },
    ...
    initFlexsliders : function() {
        ...
        dtl.initFlexByName($('.homepage-showcase .theme-detail:visible'));
    },
